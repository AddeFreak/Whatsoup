	...
	const database = [
		{
			...
			key: 1,
			name: 'The Healing',
			desc: 'Butternut squash, red onions, garlic, coconut milk',
			price: 50,
			img: healing,
			nextItem: 'PROTEIN',
		...
		},
		{
			...
			key: 2,
			name: 'So Long Cold',
			desc: 'Parsnips, rosted garlic, lemon rosmary, maple syrup',
			price: 50,
			img: solong,
			nextItem: 'PROTEIN',
			next: 'protein',
		},
		{
			...
			key: 3,
			name: 'Chillie Billie',
			desc: 'Carrots, chilli flakes, peanuts, sweet potato, coconut milk ',
			price: 50,
			img: chillie,
			nextItem: 'PROTEIN',
			next: 'protein',
		},
		{
			...
			key: 4,
			name: 'Miss Muscle',
			desc: 'Green peas, coriander, green chilli, lime, coconut milk',
			price: 50,
			img: missmuscle,
			nextItem: 'PROTEIN',
			next: 'protein',
		},
		{
			...
			key: 5,
			name: 'Low Carb',
			desc: 'Sweet potato, ginger, cummin marsala, garlic, coconut milk',
			price: 50,
			img: lowcarb,
			nextItem: 'PROTEIN',
			next: 'protein',
