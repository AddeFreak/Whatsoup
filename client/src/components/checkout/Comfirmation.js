	...
	return (
		<ConfStyle>
			<div>
				...
				<div>You will recive your order {addressItems()}</div>{' '}
				<p>You will get a notification 5 minutes before we arrive.</p>
			...
			<div className='thanks'>
				<h1>Thank you!</h1>
				<p>
					With this sustainable choice, we can ensure that both your and the
					planet's health is a priority. You’re great! Hope you will enjoy the
					food and welcome back.{' '}
				</p>
